...
build () {
    ...
    pushd $path
        ...
        if [ $path = "libmmap" ]; then
            cp --archive /inst/chiquita_5gen_tmp/Makefile /inst/5gen-c/circ-obfuscation/libmmap/tests
        fi
...
build libaesrand    https://github.com/5GenCrypto/libaesrand 5gen
build clt13         https://github.com/5GenCrypto/clt13 5gen
build gghlite       https://github.com/5GenCrypto/gghlite-flint master
build libmmap       https://github.com/5GenCrypto/libmmap 5gen
